// ==UserScript==
// @name         WEAR ME — e5346173308a
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry e5346173308a. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry e5346173308a and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "e5346173308af4bf05e37eb77a19857f90c196fbfd4d72aba32fdd09a43af917",
  "attrs": {
    "canvas.hash": "a256409f4326cd4fdd02e4967bd861c4",
    "canvas.emoji": "1dfce8d3479e316aca1db7f99a5c96b2",
    "webgl.vendor": "Google Inc. (Intel)",
    "webgl.renderer": "ANGLE (Intel, Intel(R) Iris(R) Xe Graphics (0x00003184) Direct3D11 vs_5_0 ps_5_0, D3D11)",
    ...
    "webgl.scene": "beea2e3254500317cb32fab82b25375d",
    "audio.sum": 124.04338,
    ...
    "screen.avail": "3840x2120",
    "screen.colorDepth": 24,
    "screen.pixelRatio": 1.5,
    ...
    "css.env": "color-scheme=dark;reduced-motion=no-preference;contrast=no-preference;forced-colors=none;dynamic-range=standard;gamut=p3;pointer=fine;hover=hover",
    "devices.counts": "audioinput=3;audiooutput=2;videoinput=1",
