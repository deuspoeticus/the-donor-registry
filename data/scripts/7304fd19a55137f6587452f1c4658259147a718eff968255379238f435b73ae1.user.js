// ==UserScript==
// @name         WEAR ME — 7304fd19a551
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 7304fd19a551. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 7304fd19a551 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "7304fd19a55137f6587452f1c4658259147a718eff968255379238f435b73ae1",
  "attrs": {
    "canvas.hash": "53c9991268fb940bd908f54668e736e1",
    "canvas.emoji": "6c88766789e1bdd45f292e21d88db597",
    "webgl.vendor": "ARM",
    ...
    "webgl.scene": "b0a18cbe4adf773a7839dd458147a16d",
    "audio.sum": 124.080323,
    "nav.userAgent": "Mozilla/5.0 (Linux; Android 15; SM-S911B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Mobile Safari/537.36",
    "nav.platform": "Linux armv8l",
    "nav.hardwareConcurrency": 8,
    "nav.deviceMemory": 8,
    "nav.languages": "en-US,en,en-GB",
    ...
    "css.env": "color-scheme=dark;reduced-motion=no-preference;contrast=no-preference;forced-colors=active;dynamic-range=standard;gamut=p3;pointer=coarse;hover=none",
