// ==UserScript==
// @name         WEAR ME — 701086c250a7
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 701086c250a7. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 701086c250a7 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "701086c250a7f83e2b3a95c8d109374a2138052178303b2a44c84aae9f36e635",
  "attrs": {
    "canvas.hash": "1cf0497037ba4148eb9b67895d11636c",
    "canvas.emoji": "4d3dbeaa84e4b4105da65c29086143e6",
    ...
    "webgl.scene": "6b9ace36c66adfbced3ae9fbf3fab883",
    "audio.sum": 124.043604,
    "nav.userAgent": "Mozilla/5.0 (iPhone; CPU iPhone OS 18_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.5 Mobile/15E148 Safari/604.1",
    "nav.platform": "iPhone",
    "nav.hardwareConcurrency": 6,
    "nav.deviceMemory": null,
    "nav.languages": "ko-KR,ko,en-US,en",
    ...
    "screen.avail": "393x852",
    "screen.colorDepth": 30,
    "screen.pixelRatio": 3,
    "intl.timeZone": "Asia/Seoul",
    "intl.locale": "ko-KR",
    "intl.calendar": "gregory|latn",
    "intl.offset": -540,
    "fonts.bitmask": "000000003ffe03ff",
    "fonts.count": 23,
    "voices.list": "Albert|en-US|1;Alex|en-US|1;Daniel|en-GB|1;Fiona|en-Scotland|1;Fred|en-US|1;Karen|en-AU|1;Moira|en-IE|1;Samantha|en-US|1;Tessa|en-ZA|1;Victoria|en-US|1;Yuna|ko-KR|1",
    "voices.count": 11,
    "codecs.bitmask": "1c3ef8",
    "css.env": "color-scheme=light;reduced-motion=no-preference;contrast=no-preference;forced-colors=none;dynamic-range=standard;gamut=p3;pointer=coarse;hover=none",
    "devices.counts": "audioinput=3;audiooutput=1;videoinput=1",
