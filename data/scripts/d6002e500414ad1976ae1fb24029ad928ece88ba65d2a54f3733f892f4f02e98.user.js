// ==UserScript==
// @name         WEAR ME — d6002e500414
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry d6002e500414. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry d6002e500414 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "d6002e500414ad1976ae1fb24029ad928ece88ba65d2a54f3733f892f4f02e98",
  "attrs": {
    "canvas.hash": "df5dbdcf00f011189741464896707509",
    "canvas.emoji": "bf43c8f624f7722ea20d91a3b0fc7c11",
    "webgl.vendor": "Google Inc. (AMD)",
    "webgl.renderer": "ANGLE (AMD, AMD Radeon Graphics (radeonsi, navi23, LLVM 18.1.8, DRM 3.57, 6.11.0), OpenGL 4.6)",
    ...
    "webgl.scene": "1c0485efd55ce189b94bfdd1569da3f2",
    "audio.sum": 35.749838,
    "nav.userAgent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Safari/537.36",
    ...
    "intl.offset": 240,
    "fonts.bitmask": "0000000003f000ff",
    "fonts.count": 14,
    "voices.list": "",
    "voices.count": 0,
