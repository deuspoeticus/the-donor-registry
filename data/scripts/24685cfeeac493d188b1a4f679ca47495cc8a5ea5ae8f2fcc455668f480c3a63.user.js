// ==UserScript==
// @name         WEAR ME — 24685cfeeac4
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 24685cfeeac4. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 24685cfeeac4 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "24685cfeeac493d188b1a4f679ca47495cc8a5ea5ae8f2fcc455668f480c3a63",
  "attrs": {
    "canvas.hash": "c4c51724c9d47545a62a12d80a508087",
    "canvas.emoji": "01a9b4f05676873eddf7abb01bc3f7d7",
    "webgl.vendor": "Google Inc. (NVIDIA)",
    "webgl.renderer": "ANGLE (NVIDIA, NVIDIA GeForce RTX 3060 (0x00008017) Direct3D11 vs_5_0 ps_5_0, D3D11)",
    ...
    "webgl.scene": "ec5b27ca781cfc56c256cf5bcb8c6fcc",
    "audio.sum": 124.043445,
    ...
    "intl.timeZone": "Europe/Madrid",
    "intl.locale": "es-ES",
    "intl.calendar": "gregory|latn",
    "intl.offset": -120,
    "fonts.bitmask": "00000003ff3f01ff",
    "fonts.count": 25,
    "voices.list": "Microsoft David - English (United States)|en-US|1;Microsoft Hazel - English (Great Britain)|en-GB|1;Microsoft Helena - Spanish (Spain)|es-ES|1;Microsoft Mark - English (United States)|en-US|1;Microsoft Zira - English (United States)|en-US|1",
    "voices.count": 5,
    "codecs.bitmask": "3f7ffe",
    "css.env": "color-scheme=light;reduced-motion=no-preference;contrast=no-preference;forced-colors=none;dynamic-range=high;gamut=p3;pointer=fine;hover=hover",
    "devices.counts": "audioinput=0;audiooutput=1;videoinput=0",
