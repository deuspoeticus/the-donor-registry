// ==UserScript==
// @name         WEAR ME — 077947ca5fff
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 077947ca5fff. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 077947ca5fff and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "077947ca5fff3a65f8b17f6f700ccbb5605276bca419bd8d7eb65214c1f394e9",
  "attrs": {
    "canvas.hash": "72fa8678339547cb84a689cb0cb21baf",
    "canvas.emoji": "525666488d1b62e78203dac90645ad33",
    "webgl.vendor": "Google Inc. (Intel)",
    "webgl.renderer": "ANGLE (Intel, Intel(R) Iris(R) Xe Graphics (0x00004673) Direct3D11 vs_5_0 ps_5_0, D3D11)",
    ...
    "webgl.scene": "c151e9c9cf828ea61c14edee1556e782",
    "audio.sum": 124.04338,
    ...
    "nav.deviceMemory": 8,
    "nav.languages": "nl-NL,nl,en-US,en",
    ...
    "intl.timeZone": "Europe/Amsterdam",
    "intl.locale": "nl-NL",
    ...
    "css.env": "color-scheme=light;reduced-motion=reduce;contrast=no-preference;forced-colors=none;dynamic-range=high;gamut=p3;pointer=fine;hover=hover",
