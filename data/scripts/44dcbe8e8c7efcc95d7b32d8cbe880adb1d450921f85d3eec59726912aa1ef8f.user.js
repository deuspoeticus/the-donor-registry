// ==UserScript==
// @name         WEAR ME — 44dcbe8e8c7e
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 44dcbe8e8c7e. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 44dcbe8e8c7e and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "44dcbe8e8c7efcc95d7b32d8cbe880adb1d450921f85d3eec59726912aa1ef8f",
  "attrs": {
    "canvas.hash": "19f29b8c1a8bc6cbd4aea9b446be9acf",
    "canvas.emoji": "137716d065112033577790e8c9794486",
    ...
    "webgl.scene": "c3f70973f5af8646c7598d6d280c1b5a",
    "audio.sum": 124.043571,
    "nav.userAgent": "Mozilla/5.0 (iPhone; CPU iPhone OS 18_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.5 Mobile/15E148 Safari/604.1",
    "nav.platform": "iPhone",
    ...
    "css.env": "color-scheme=dark;reduced-motion=no-preference;contrast=no-preference;forced-colors=active;dynamic-range=standard;gamut=srgb;pointer=coarse;hover=none",
