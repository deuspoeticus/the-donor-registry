// ==UserScript==
// @name         WEAR ME — 8253a9ae0a30
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 8253a9ae0a30. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 8253a9ae0a30 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "8253a9ae0a30fb25bdd6538c96856c20057a6846c8a825e33475b94ff3ca6803",
  "attrs": {
    "canvas.hash": "ae2bf25f060f62ac0671a93948c707a2",
    "canvas.emoji": "765787655df79c22a14459ca6734b33c",
    ...
    "webgl.scene": "fa74d35d28d0ad1114c1e101e598541c",
    "audio.sum": 124.043586,
    "nav.userAgent": "Mozilla/5.0 (iPhone; CPU iPhone OS 26_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/26.0 Mobile/15E148 Safari/604.1",
    "nav.platform": "iPhone",
    ...
    "css.env": "color-scheme=dark;reduced-motion=reduce;contrast=no-preference;forced-colors=none;dynamic-range=standard;gamut=p3;pointer=coarse;hover=none",
