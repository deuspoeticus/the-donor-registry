// ==UserScript==
// @name         WEAR ME — d5e9c9d4afe2
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry d5e9c9d4afe2. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry d5e9c9d4afe2 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "d5e9c9d4afe2d1638d5f7a7fb3e73986206fd0a90ce3ac50de713fc2cfee9290",
  "attrs": {
    "canvas.hash": "f3bd90e03053563808272b4e20304ced",
    "canvas.emoji": "9c8a28a521fc44d6c89c2e3e138f3f58",
    "webgl.vendor": "Qualcomm",
    "webgl.renderer": "Adreno (TM) 730",
    ...
    "webgl.precision": "vh=127,127,23;vm=15,15,10;fh=127,127,23;fm=15,15,10",
    "webgl.limits": "maxTexture=8192;maxViewport=8192x8192;maxRenderbuffer=8192",
    "webgl.scene": "6ac742ce9250b04b26cc44a98d2bba5a",
    "audio.sum": 124.080323,
    "nav.userAgent": "Mozilla/5.0 (Linux; Android 13; SM-A546B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Mobile Safari/537.36",
    ...
    "nav.webdriver": false,
    "ch.brands": "[{\"brand\":\"Chromium\",\"version\":\"139\"},{\"brand\":\"Google Chrome\",\"version\":\"139\"},{\"brand\":\"Not=A?Brand\",\"version\":\"24\"}]",
    "ch.platformVersion": "13.0.0",
    "ch.architecture": "",
    "ch.model": "SM-A546B",
    "screen.resolution": "360x800",
    "screen.avail": "360x800",
    ...
    "intl.offset": -120,
    "fonts.bitmask": "000000001f0e00ff",
    "fonts.count": 16,
    "voices.list": "Google Deutsch|de-DE|0;Google UK English Female|en-GB|0;Google UK English Male|en-GB|0;Google US English|en-US|0",
    "voices.count": 4,
    "codecs.bitmask": "3f7ffe",
    "css.env": "color-scheme=dark;reduced-motion=no-preference;contrast=no-preference;forced-colors=none;dynamic-range=standard;gamut=srgb;pointer=coarse;hover=none",
    "devices.counts": "audioinput=2;audiooutput=1;videoinput=2",
    "math.quirks": "99ce34ab94b501cfe43debe1",
