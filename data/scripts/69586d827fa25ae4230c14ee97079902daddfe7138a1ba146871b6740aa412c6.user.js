// ==UserScript==
// @name         WEAR ME — 69586d827fa2
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 69586d827fa2. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 69586d827fa2 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "69586d827fa25ae4230c14ee97079902daddfe7138a1ba146871b6740aa412c6",
  "attrs": {
    "canvas.hash": "f03578ce35090812ec16e49d6ce2d8f7",
    "canvas.emoji": "d5067f152c1d08d30b9cbf0c3190ceea",
    "webgl.vendor": "Mozilla",
    "webgl.renderer": "ANGLE (NVIDIA, NVIDIA GeForce GTX 1660 Direct3D11 vs_5_0 ps_5_0, D3D11)",
    ...
    "webgl.scene": "a3254a67c30bc58fbd97275ca619335f",
    "audio.sum": 35.749294,
    "nav.userAgent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:141.0) Gecko/20100101 Firefox/141.0",
    "nav.platform": "Win32",
    ...
    "fonts.count": 28,
    "voices.list": "Microsoft David - English (United States)|en-US|1;Microsoft Hazel - English (Great Britain)|en-GB|1;Microsoft Mark - English (United States)|en-US|1;Microsoft Zira - English (United States)|en-US|1",
    "voices.count": 4,
    "codecs.bitmask": "2f5ffa",
    "css.env": "color-scheme=dark;reduced-motion=no-preference;contrast=no-preference;forced-colors=none;dynamic-range=high;gamut=p3;pointer=fine;hover=hover",
    "devices.counts": "audioinput=1;audiooutput=1;videoinput=0",
