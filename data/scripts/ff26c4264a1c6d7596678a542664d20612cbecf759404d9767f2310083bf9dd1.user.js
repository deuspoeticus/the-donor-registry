// ==UserScript==
// @name         WEAR ME — ff26c4264a1c
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry ff26c4264a1c. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry ff26c4264a1c and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "ff26c4264a1c6d7596678a542664d20612cbecf759404d9767f2310083bf9dd1",
  "attrs": {
    "canvas.hash": "633238b2f6399fdc51f27ccc72a0edf2",
    "canvas.emoji": "a3f12fa02e5775640ea16e6aaf50823a",
    ...
    "webgl.scene": "e8cc4fddc4f6e1db3229eb8e2241ac77",
    "audio.sum": 124.084899,
    "nav.userAgent": "Mozilla/5.0 (Linux; Android 13; 2201116SG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/139.0.0.0 Mobile Safari/537.36",
    ...
    "ch.architecture": "",
    "ch.model": "2201116SG",
    "screen.resolution": "384x832",
    "screen.avail": "384x832",
    "screen.colorDepth": 24,
    "screen.pixelRatio": 2.8125,
    ...
    "css.env": "color-scheme=dark;reduced-motion=no-preference;contrast=no-preference;forced-colors=none;dynamic-range=high;gamut=p3;pointer=coarse;hover=none",
