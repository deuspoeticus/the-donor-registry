// ==UserScript==
// @name         WEAR ME — 76d1550390e2
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 76d1550390e2. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 76d1550390e2 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "76d1550390e2945d86f363ff06a376cd5bae2d13003f68ba20a1c8e8eb048f1b",
  "attrs": {
    "canvas.hash": "1127796e13df6d48fb2f3f422e675e38",
    "canvas.emoji": "29999d369d73a4d71c8634c1aeac5744",
    ...
    "webgl.scene": "f60efb53a3736a5422726df4b21e4d42",
    "audio.sum": 124.084899,
    "nav.userAgent": "Mozilla/5.0 (Linux; Android 14; Pixel 8) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/136.0.0.0 Mobile Safari/537.36",
    ...
    "css.env": "color-scheme=light;reduced-motion=no-preference;contrast=no-preference;forced-colors=active;dynamic-range=high;gamut=srgb;pointer=coarse;hover=none",
