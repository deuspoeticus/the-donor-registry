// ==UserScript==
// @name         WEAR ME — 4b5a924bfda8
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry 4b5a924bfda8. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry 4b5a924bfda8 and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "4b5a924bfda81aa9e20deeba806d9ae36def0d05f85744f5f4cac3ca91ff6397",
  "attrs": {
    "canvas.hash": "e082638434551ec9fcef4e358e3296fd",
    "canvas.emoji": "738d419908396d67cecc95911f779b63",
    ...
    "webgl.scene": "4921bbdc0118bd155b3f033cca942f20",
    ...
    "nav.languages": "pl-PL,pl,en-US,en",
    ...
    "fonts.count": 28,
    "voices.list": "Albert|en-US|1;Alex|en-US|1;Daniel|en-GB|1;Fiona|en-Scotland|1;Fred|en-US|1;Karen|en-AU|1;Moira|en-IE|1;Samantha|en-US|1;Tessa|en-ZA|1;Victoria|en-US|1;Zosia|pl-PL|1",
    "voices.count": 11,
    "codecs.bitmask": "1c3ef8",
    "css.env": "color-scheme=light;reduced-motion=no-preference;contrast=no-preference;forced-colors=active;dynamic-range=standard;gamut=srgb;pointer=fine;hover=hover",
