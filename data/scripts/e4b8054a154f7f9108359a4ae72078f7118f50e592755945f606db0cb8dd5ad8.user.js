// ==UserScript==
// @name         WEAR ME — e4b8054a154f
// @namespace    https://deuspoeticus.github.io/the-donor-registry/
// @version      1.0.0
// @description  Presents pool entry e4b8054a154f. Deterministic per identity, identical for every wearer.
 ...
 * though it were yours. It was generated for entry e4b8054a154f and every wearer of
...
(function () {
  ...
  var CONFIG = {
  "id": "e4b8054a154f7f9108359a4ae72078f7118f50e592755945f606db0cb8dd5ad8",
  "attrs": {
    "canvas.hash": "ffa750699b9e872c9333eb37c2a1fcf4",
    "canvas.emoji": "d666fe63b0e80c9519fbad78ae7d590f",
    ...
    "webgl.scene": "2cb1f5204b86c962b4f66e0b3f7c27ed",
    "audio.sum": 124.043604,
    "nav.userAgent": "Mozilla/5.0 (iPhone; CPU iPhone OS 18_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1",
    "nav.platform": "iPhone",
    "nav.hardwareConcurrency": 8,
    "nav.deviceMemory": null,
    "nav.languages": "en-GB,en,de",
    ...
    "ch.model": null,
    "screen.resolution": "402x874",
    "screen.avail": "402x874",
    ...
    "intl.offset": -120,
    "fonts.bitmask": "000000003ffe01ff",
    "fonts.count": 22,
    ...
    "css.env": "color-scheme=light;reduced-motion=no-preference;contrast=no-preference;forced-colors=none;dynamic-range=high;gamut=p3;pointer=coarse;hover=none",
    "devices.counts": "audioinput=1;audiooutput=3;videoinput=2",
    "math.quirks": "cc16855b46a6c20865469e78",
    "storage.quota": 4294967296
  },
  "canvasMode": "converge",
  "audioMode": "converge",
  "hideOverrides": false
