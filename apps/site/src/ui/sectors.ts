...
const SECTORS = [
  {
    ...
    sigil: 'eye',
    requires: 'pool',
    gist: 'What this page is, and what it is about to do.',
  },
  {
    id: 'pool',
    address: '01',
  ...
  },
  {
    ...
    sigil: 'serpent',
    requires: 'pool',
    gist: 'Measured, donated, worn — and where each step leads.',
  },
  {
    id: 'consent',
    address: '03',
  ...
  },
  {
    ...
    gist: 'Your own signature, and what the pool can say about it.',
  },
  {
    id: 'inference',
    address: '05',
    ...
    sigil: 'orb',
    requires: 'measurement',
    gist: 'Read as a person or read as an agent. An attribute, never a gate.',
  },
  {
    id: 'receipt',
    address: '06',
    ...
    sigil: 'scroll',
    requires: 'donation',
    gist: 'What was transmitted, and the token that withdraws it.',
  },
  {
    id: 'model',
    address: '07',
    ...
    sigil: 'web',
    requires: 'pool',
    gist: "The dependency structure the pool fits over people.",
  },
  {
    id: 'forge',
    address: '08',
  ...
  },
  {
    ...
    sigil: 'mask',
    requires: 'selection',
    gist: 'One entry in full, and the script that presents it as yours.',
  },
